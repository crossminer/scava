...
public class RascalMetricProvider implements ITransientMetricProvider<RascalMetrics> {
	...
	private final boolean hasHistoric;
	...
	public RascalMetricProvider(String bundleId, String metricName, String shortMetricId, String friendlyName, String description, boolean hasHistoric, AbstractFunction function, Map<String,String> uses) {
	...
	public void measure(Project project, ProjectDelta delta, RascalMetrics db) {
		...
		// We still need to store null values if the transient metric
		// has an historic metric associated to reset the values
		if (result != null || hasHistoric) {
