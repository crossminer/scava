...
//			System.exit(-1);
	...
	public String getShortIdentifier() {
		return "trans.bugs.hourlyrequestsreplies";
	}

	@Override
	public String getFriendlyName() {
		return "Number of bug comments, requests and replies per hour";
	}

	@Override
	public String getSummaryInformation() {
		return "This metric computes the number of bug comments, including those "
				+ "regarded as requests and replies, every hour of the day, per bug tracker.";
	}
