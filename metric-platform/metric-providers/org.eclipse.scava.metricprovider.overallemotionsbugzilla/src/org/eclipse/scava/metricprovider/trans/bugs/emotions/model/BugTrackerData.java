...
public class BugTrackerData extends Pongo {
	...
	public BugTrackerData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.scava.metricprovider.trans.bugs.emotions.model.BugTrackerData");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.scava.metricprovider.trans.bugs.emotions.model.BugTrackerData");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.eclipse.scava.metricprovider.trans.bugs.emotions.model.BugTrackerData");
	}
