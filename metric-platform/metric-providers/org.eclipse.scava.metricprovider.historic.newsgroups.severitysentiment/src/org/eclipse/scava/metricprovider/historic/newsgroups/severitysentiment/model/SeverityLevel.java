 ...
 ******************************************************************************/
package org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model;
...
public class SeverityLevel extends Pongo {
	...
	public SeverityLevel() { 
		super();
		SEVERITYLEVEL.setOwningType("org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		NUMBEROFTHREADS.setOwningType("org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		AVERAGESENTIMENT.setOwningType("org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		SENTIMENTATTHREADBEGGINING.setOwningType("org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		SENTIMENTATTHREADEND.setOwningType("org.eclipse.scava.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
	}
