...
public class Smell extends Pongo {
	...
	public Smell() { 
		super();
		SMELLNAME.setOwningType("org.eclipse.scava.metricprovider.trans.configuration.puppet.model.Smell");
		REASON.setOwningType("org.eclipse.scava.metricprovider.trans.configuration.puppet.model.Smell");
		FILENAME.setOwningType("org.eclipse.scava.metricprovider.trans.configuration.puppet.model.Smell");
	}
