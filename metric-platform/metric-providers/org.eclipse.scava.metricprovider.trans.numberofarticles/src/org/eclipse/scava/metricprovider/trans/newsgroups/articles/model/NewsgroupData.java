...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.scava.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.eclipse.scava.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
		CUMULATIVENUMBEROFARTICLES.setOwningType("org.eclipse.scava.metricprovider.trans.newsgroups.articles.model.NewsgroupData");
	}
