 ...
 *******************************************************************************/
package org.eclipse.crossmeter.factoid.bugs.severity;

import java.text.DecimalFormat;
import java.util.Arrays;
import java.util.List;

import org.eclipse.crossmeter.metricprovider.historic.bugs.severity.SeverityHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severity.model.BugData;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severity.model.BugsSeveritiesHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severity.model.SeverityLevel;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.SeverityBugStatusHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.BugsSeverityBugStatusHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severityresponsetime.SeverityResponseTimeHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severityresponsetime.model.BugsSeverityResponseTimeHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.bugs.severitysentiment.SeveritySentimentHistoricMetricProvider;
...
//			  sentimentEnhancementBugs = getSentimentOfSeverityBugs(severitySentimentList, "enhancement"),
	...
	private int getNumberOfSeverityStatusBugs(List<Pongo> severityStatusList, String severityType) {
		if ( severityStatusList.size() > 0 ) {
			...
			for (org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel 
...
//			for (org.eclipse.crossmeter.metricprovider.historic.bugs.severitysentiment.model.SeverityLevel 
//					severityLevel: severityPongo.getSeverityLevels())
//				numberOfBugs += severityLevel.getNumberOfBugs();
//			return numberOfBugs;
//		}
...
//			for (org.eclipse.crossmeter.metricprovider.historic.bugs.severityresponsetime.model.SeverityLevel 
//					severityLevel: severityPongo.getSeverityLevels())
