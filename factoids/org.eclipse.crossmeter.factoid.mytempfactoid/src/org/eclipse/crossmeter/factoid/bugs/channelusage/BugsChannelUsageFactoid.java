 ...
 ******************************************************************************/
package org.eclipse.crossmeter.factoid.bugs.channelusage;
...
import org.eclipse.crossmeter.metricprovider.historic.bugs.comments.CommentsHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.bugs.comments.model.BugsCommentsHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.NewBugsHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.model.BugsNewBugsHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.model.DailyBugData;
import org.eclipse.crossmeter.metricprovider.historic.bugs.patches.PatchesHistoricMetricProvider;
...
//		}
	...
	private int parseCommentsPongos(List<Pongo> commentsList, Map<String, Integer> trackerComments) {
		...
		for (Pongo pongo: commentsList) {
			...
			for (org.eclipse.crossmeter.metricprovider.historic.bugs.comments.model.DailyBugData 
	...
	private int parsePatchesPongos(List<Pongo> patchesList, Map<String, Integer> trackerPatches) {
		...
		for (Pongo pongo: patchesList) {
			...
			for (org.eclipse.crossmeter.metricprovider.historic.bugs.patches.model.DailyBugData 
