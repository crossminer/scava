 ...
 *******************************************************************************/
package org.eclipse.crossmeter.factoid.newsgroups.channelusage;
...
import org.eclipse.crossmeter.metricprovider.historic.newsgroups.articles.ArticlesHistoricMetricProvider;
import org.eclipse.crossmeter.metricprovider.historic.newsgroups.articles.model.DailyNewsgroupData;
import org.eclipse.crossmeter.metricprovider.historic.newsgroups.articles.model.NewsgroupsArticlesHistoricMetric;
import org.eclipse.crossmeter.metricprovider.historic.newsgroups.newthreads.NewThreadsHistoricMetricProvider;
...
//		System.err.println("---USAGE===RETRIEVED PONGOLIST FOR " + articlesList.size() + " DAYS===---");
	...
	private int parseThreadsPongos(List<Pongo> threadsList, Map<String, Integer> newsgroupThreads) {
		...
		for (Pongo pongo: threadsList) {
			...
			for ( org.eclipse.crossmeter.metricprovider.historic.newsgroups.newthreads.model.DailyNewsgroupData 
