...
public class NewsgroupArticleData extends Pongo {
	...
	public NewsgroupArticleData() { 
		...
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		ARTICLENUMBER.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		UNIGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		BIGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		TRIGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		QUADGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		CHARTRIGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		CHARQUADGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
		CHARFIVEGRAMS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.severityclassification.model.NewsgroupArticleData");
	}
