...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.requestsreplies.model.DailyNewsgroupData");
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.requestsreplies.model.DailyNewsgroupData");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.requestsreplies.model.DailyNewsgroupData");
		CUMULATIVENUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.requestsreplies.model.DailyNewsgroupData");
		CUMULATIVENUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.requestsreplies.model.DailyNewsgroupData");
	}
