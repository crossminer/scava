...
public class NewsgroupArticlesData extends Pongo {
	...
	public NewsgroupArticlesData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupArticlesData");
		ARTICLENUMBER.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupArticlesData");
		SUBJECT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupArticlesData");
		TEXT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupArticlesData");
		DATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupArticlesData");
	}
