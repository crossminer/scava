...
public class BugTrackerCommentsData extends Pongo {
	...
	public BugTrackerCommentsData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		BUGID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		COMMENTID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		SUBJECT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		TEXT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
		DATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.BugTrackerCommentsData");
	}
