...
public class NewsgroupTopic extends Pongo {
	...
	public NewsgroupTopic() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupTopic");
		LABEL.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupTopic");
		NUMBEROFDOCUMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.topics.model.NewsgroupTopic");
	}
