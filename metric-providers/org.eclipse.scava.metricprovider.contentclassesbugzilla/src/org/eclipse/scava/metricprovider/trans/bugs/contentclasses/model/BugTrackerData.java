...
public class BugTrackerData extends Pongo {
	...
	public BugTrackerData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.scava.metricprovider.trans.bugs.contentclasses.model.BugTrackerData");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.scava.metricprovider.trans.bugs.contentclasses.model.BugTrackerData");
	}
