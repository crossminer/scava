 ...
 ******************************************************************************/
package org.eclipse.crossmeter.metricprovider.historic.bugs.status.model;
...
public class BugsStatusHistoricMetric extends Pongo {
	...
	public BugsStatusHistoricMetric() { 
		super();
		NUMBEROFBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFWONTFIXBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFWORKSFORMEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFNONRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFINVALIDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFFIXEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
		NUMBEROFDUPLICATEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.status.model.BugsStatusHistoricMetric");
	}
