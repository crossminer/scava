...
public class Dimension extends Pongo {
	...
	public Dimension() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
		EMOTIONLABEL.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
		PERCENTAGE.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
		CUMULATIVEPERCENTAGE.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.Dimension");
	}
