...
public class BugData extends Pongo {
	...
	public BugData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.BugData");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.BugData");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.emotions.model.BugData");
	}
