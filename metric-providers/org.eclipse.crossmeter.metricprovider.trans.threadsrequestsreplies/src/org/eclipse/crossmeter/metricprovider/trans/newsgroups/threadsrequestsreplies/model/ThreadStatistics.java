...
public class ThreadStatistics extends Pongo {
	...
	public ThreadStatistics() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
		THREADID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
		FIRSTREQUEST.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
		ANSWERED.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
		RESPONSEDURATIONSEC.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
		RESPONSEDATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threadsrequestsreplies.model.ThreadStatistics");
	}
