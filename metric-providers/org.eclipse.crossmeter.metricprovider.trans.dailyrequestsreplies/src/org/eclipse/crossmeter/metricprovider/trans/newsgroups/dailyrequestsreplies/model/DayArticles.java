...
public class DayArticles extends Pongo {
	...
	public DayArticles() { 
		super();
		NAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		NUMBEROFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		PERCENTAGEOFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		PERCENTAGEOFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
		PERCENTAGEOFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.dailyrequestsreplies.model.DayArticles");
	}
