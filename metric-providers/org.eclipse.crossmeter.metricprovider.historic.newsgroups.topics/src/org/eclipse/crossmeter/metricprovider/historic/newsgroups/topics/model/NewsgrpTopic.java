...
public class NewsgrpTopic extends Pongo {
	...
	public NewsgrpTopic() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.topics.model.NewsgrpTopic");
		LABEL.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.topics.model.NewsgrpTopic");
		NUMBEROFDOCUMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.topics.model.NewsgrpTopic");
	}
