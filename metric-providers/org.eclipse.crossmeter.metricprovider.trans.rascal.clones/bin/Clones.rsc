...
import org::eclipse::crossmeter::metricprovider::ProjectDelta;
...
@appliesTo{generic()}
@uses{("org.eclipse.crossmeter.metricprovider.trans.rascal.LOC.locPerLanguage": "locPerLanguage", "cloneLOCPerLanguage": "cloneLOCPerLanguage")}
