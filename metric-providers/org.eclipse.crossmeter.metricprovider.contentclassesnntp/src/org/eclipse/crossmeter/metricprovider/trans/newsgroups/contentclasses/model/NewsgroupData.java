...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.contentclasses.model.NewsgroupData");
		NUMBEROFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.contentclasses.model.NewsgroupData");
	}
