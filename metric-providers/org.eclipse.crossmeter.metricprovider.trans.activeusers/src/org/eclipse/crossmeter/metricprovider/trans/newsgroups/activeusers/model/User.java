...
public class User extends Pongo {
	...
	public User() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
		USERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
		LASTACTIVITYDATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
		ARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
		REQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
		REPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.activeusers.model.User");
	}
