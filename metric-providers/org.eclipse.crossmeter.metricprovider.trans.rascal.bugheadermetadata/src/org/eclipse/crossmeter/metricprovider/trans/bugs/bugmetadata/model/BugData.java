...
public class BugData extends Pongo {
	...
	public BugData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		BUGID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		STATUS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		RESOLUTION.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		OPERATINGSYSTEM.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		PRIORITY.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		CREATIONTIME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		LASTCLOSEDTIME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		AVERAGESENTIMENT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		STARTSENTIMENT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
		ENDSENTIMENT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.bugmetadata.model.BugData");
	}
