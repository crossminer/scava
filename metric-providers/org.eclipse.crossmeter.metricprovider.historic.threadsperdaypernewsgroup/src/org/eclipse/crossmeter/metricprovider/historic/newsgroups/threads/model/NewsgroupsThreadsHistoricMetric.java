...
public class NewsgroupsThreadsHistoricMetric extends Pongo {
	...
	public NewsgroupsThreadsHistoricMetric() { 
		...
		NUMBEROFTHREADS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEARTICLESPERTHREAD.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEREQUESTSPERTHREAD.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEREPLIESPERTHREAD.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEARTICLESPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEREQUESTSPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
		AVERAGEREPLIESPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.threads.model.NewsgroupsThreadsHistoricMetric");
	}
