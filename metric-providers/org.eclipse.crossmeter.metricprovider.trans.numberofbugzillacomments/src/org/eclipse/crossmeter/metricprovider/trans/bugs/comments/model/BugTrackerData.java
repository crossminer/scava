...
public class BugTrackerData extends Pongo {
	...
	public BugTrackerData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.comments.model.BugTrackerData");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.comments.model.BugTrackerData");
		CUMULATIVENUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.comments.model.BugTrackerData");
	}
