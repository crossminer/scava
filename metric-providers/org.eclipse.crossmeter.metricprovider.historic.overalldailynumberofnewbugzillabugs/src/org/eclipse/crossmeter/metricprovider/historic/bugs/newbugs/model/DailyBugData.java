...
public class DailyBugData extends Pongo {
	...
	public DailyBugData() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.model.DailyBugData");
		NUMBEROFBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.model.DailyBugData");
		CUMULATIVENUMBEROFBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.newbugs.model.DailyBugData");
	}
