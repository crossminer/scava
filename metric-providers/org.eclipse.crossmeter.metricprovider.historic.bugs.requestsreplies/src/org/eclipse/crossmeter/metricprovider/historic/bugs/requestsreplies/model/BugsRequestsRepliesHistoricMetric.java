...
public class BugsRequestsRepliesHistoricMetric extends Pongo {
	...
	public BugsRequestsRepliesHistoricMetric() { 
		...
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.requestsreplies.model.BugsRequestsRepliesHistoricMetric");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.requestsreplies.model.BugsRequestsRepliesHistoricMetric");
		CUMULATIVENUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.requestsreplies.model.BugsRequestsRepliesHistoricMetric");
		CUMULATIVENUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.requestsreplies.model.BugsRequestsRepliesHistoricMetric");
	}
