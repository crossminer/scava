 ...
 ******************************************************************************/
package org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model;
...
public class SeverityLevel extends Pongo {
	...
	public SeverityLevel() { 
		super();
		SEVERITYLEVEL.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFWONTFIXBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFWONTFIXBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFWORKSFORMEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFWORKSFORMEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFNONRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFNONRESOLVEDCLOSEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFINVALIDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFINVALIDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFFIXEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFFIXEDBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		NUMBEROFDUPLICATEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
		PERCENTAGEOFDUPLICATEBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.severitybugstatus.model.SeverityLevel");
	}
