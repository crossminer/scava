...
import org.eclipse.crossmeter.sentimentclassifier.opennlptartarus.libsvm.featuretools.CMUclustersSingleton;
import org.eclipse.crossmeter.sentimentclassifier.opennlptartarus.libsvm.featuretools.SentimentAnalysisLexicaSingleton;
...
//        			  "colchicine-treated mice."
    	...
    	CMUclustersSingleton cmuClusters = CMUclustersSingleton.getInstance(); 
    	cmuClusters.getClusters().load();
    	
    	SentimentAnalysisLexicaSingleton sentimentAnalysisLexica = 
    			SentimentAnalysisLexicaSingleton.getInstance(); 
    	sentimentAnalysisLexica.getLexica().load();
        ...
        System.out.println(classificationInstance1.getComposedId() + 
        		" -> " + EmotionalDimensions.getDimensions(classificationInstance1));
        System.out.println(classificationInstance2.getComposedId() + 
        		" -> " + EmotionalDimensions.getDimensions(classificationInstance2));
        System.out.println(classificationInstance3.getComposedId() + 
        		" -> " + EmotionalDimensions.getDimensions(classificationInstance3));
        System.out.println(classificationInstance4.getComposedId() + 
        		" -> " + EmotionalDimensions.getDimensions(classificationInstance4));
      }
