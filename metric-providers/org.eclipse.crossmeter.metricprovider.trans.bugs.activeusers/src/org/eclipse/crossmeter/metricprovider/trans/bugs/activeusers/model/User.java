...
public class User extends Pongo {
	...
	public User() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
		USERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
		LASTACTIVITYDATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
		COMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
		REQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
		REPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.activeusers.model.User");
	}
