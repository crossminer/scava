...
public class RepositoryData extends Pongo {
	...
	public RepositoryData() { 
		super();
		URL.setOwningType("org.eclipse.crossmeter.metricprovider.historic.commitsovertime.model.RepositoryData");
		REPOTYPE.setOwningType("org.eclipse.crossmeter.metricprovider.historic.commitsovertime.model.RepositoryData");
		REVISION.setOwningType("org.eclipse.crossmeter.metricprovider.historic.commitsovertime.model.RepositoryData");
		NUMBEROFCOMMITS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.commitsovertime.model.RepositoryData");
	}
