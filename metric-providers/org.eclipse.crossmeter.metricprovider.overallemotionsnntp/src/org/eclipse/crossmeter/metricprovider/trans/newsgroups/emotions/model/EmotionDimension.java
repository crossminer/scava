...
public class EmotionDimension extends Pongo {
	...
	public EmotionDimension() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
		EMOTIONLABEL.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
		NUMBEROFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
		CUMULATIVENUMBEROFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
		PERCENTAGE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
		CUMULATIVEPERCENTAGE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.emotions.model.EmotionDimension");
	}
