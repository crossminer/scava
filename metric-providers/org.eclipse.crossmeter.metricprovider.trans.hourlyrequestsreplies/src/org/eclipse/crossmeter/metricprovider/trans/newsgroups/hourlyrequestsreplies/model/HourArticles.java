...
public class HourArticles extends Pongo {
	...
	public HourArticles() { 
		super();
		HOUR.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		NUMBEROFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		PERCENTAGEOFARTICLES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		PERCENTAGEOFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
		PERCENTAGEOFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.hourlyrequestsreplies.model.HourArticles");
	}
