 ...
 ******************************************************************************/
package org.eclipse.crossmeter.metricprovider.historic.newsgroups.users.model;
...
public class DailyNewsgroupData extends Pongo {
	...
	public DailyNewsgroupData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.users.model.DailyNewsgroupData");
		NUMBEROFUSERS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.users.model.DailyNewsgroupData");
		NUMBEROFACTIVEUSERS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.users.model.DailyNewsgroupData");
		NUMBEROFINACTIVEUSERS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.users.model.DailyNewsgroupData");
	}
