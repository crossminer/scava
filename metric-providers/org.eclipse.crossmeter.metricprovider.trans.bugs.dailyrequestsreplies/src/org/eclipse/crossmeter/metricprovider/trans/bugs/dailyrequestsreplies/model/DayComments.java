...
public class DayComments extends Pongo {
	...
	public DayComments() { 
		super();
		NAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		PERCENTAGEOFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		PERCENTAGEOFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
		PERCENTAGEOFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.dailyrequestsreplies.model.DayComments");
	}
