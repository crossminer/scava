...
public class HourComments extends Pongo {
	...
	public HourComments() { 
		super();
		BUGTRACKERID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		HOUR.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		NUMBEROFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFCOMMENTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFREQUESTS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
		PERCENTAGEOFREPLIES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.bugs.hourlyrequestsreplies.model.HourComments");
	}
