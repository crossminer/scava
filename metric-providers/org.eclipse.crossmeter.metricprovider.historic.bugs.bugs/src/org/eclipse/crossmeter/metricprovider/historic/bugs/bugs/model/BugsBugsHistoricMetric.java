...
public class BugsBugsHistoricMetric extends Pongo {
	...
	public BugsBugsHistoricMetric() { 
		...
		NUMBEROFBUGS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGECOMMENTSPERBUG.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGEREQUESTSPERBUG.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGEREPLIESPERBUG.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGECOMMENTSPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGEREQUESTSPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
		AVERAGEREPLIESPERUSER.setOwningType("org.eclipse.crossmeter.metricprovider.historic.bugs.bugs.model.BugsBugsHistoricMetric");
	}
