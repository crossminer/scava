...
public class ArticleData extends Pongo {
	...
	public ArticleData() { 
		super();
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		ARTICLENUMBER.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		ARTICLEID.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		DATE.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		FROM.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		SUBJECT.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		CONTENTCLASS.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
		REFERENCES.setOwningType("org.eclipse.crossmeter.metricprovider.trans.newsgroups.threads.model.ArticleData");
	}
