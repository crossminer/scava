...
public class SeverityLevel extends Pongo {
	...
	public SeverityLevel() { 
		super();
		SEVERITYLEVEL.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		NUMBEROFTHREADS.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		AVERAGESENTIMENT.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		SENTIMENTATTHREADBEGGINING.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
		SENTIMENTATTHREADEND.setOwningType("org.eclipse.crossmeter.metricprovider.historic.newsgroups.severitysentiment.model.SeverityLevel");
	}
