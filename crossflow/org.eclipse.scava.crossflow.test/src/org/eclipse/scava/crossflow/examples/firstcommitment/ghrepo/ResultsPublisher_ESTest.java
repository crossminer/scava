...
public class ResultsPublisher_ESTest extends ResultsPublisher_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          ResultsPublisher resultsPublisher0 = null;
          try {
            resultsPublisher0 = new ResultsPublisher(workflow0);
            fail("Expecting exception: JMSException");
             ...
             // org.eclipse.scava.crossflow.examples.firstcommitment.ghrepo.ResultsPublisher.<init>(ResultsPublisher.java:31)
  ...
  public void test1()  throws Throwable  {
      ResultsPublisher resultsPublisher0 = null;
      try {
        resultsPublisher0 = new ResultsPublisher((Workflow) null);
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.eclipse.scava.crossflow.examples.firstcommitment.ghrepo.ResultsPublisher", e);
      }
  }
}
