...
public class AdditionResults_ESTest extends AdditionResults_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          AdditionResults additionResults0 = null;
          try {
            additionResults0 = new AdditionResults(additionExample0);
            fail("Expecting exception: JMSException");
             ...
             // org.eclipse.scava.crossflow.examples.addition.AdditionResults.<init>(AdditionResults.java:31)
  ...
  public void test1()  throws Throwable  {
      AdditionResults additionResults0 = null;
      try {
        additionResults0 = new AdditionResults((Workflow) null);
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.eclipse.scava.crossflow.examples.addition.AdditionResults", e);
      }
  }
}
