...
public class MdeTechnologyClonedRepoEntriesForFileCounter_ESTest extends MdeTechnologyClonedRepoEntriesForFileCounter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          MdeTechnologyClonedRepoEntriesForFileCounter mdeTechnologyClonedRepoEntriesForFileCounter0 = null;
          try {
            mdeTechnologyClonedRepoEntriesForFileCounter0 = new MdeTechnologyClonedRepoEntriesForFileCounter(workflow0);
            fail("Expecting exception: JMSException");
             ...
             // org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForFileCounter.<init>(MdeTechnologyClonedRepoEntriesForFileCounter.java:31)
  ...
  public void test1()  throws Throwable  {
      MdeTechnologyClonedRepoEntriesForFileCounter mdeTechnologyClonedRepoEntriesForFileCounter0 = null;
      try {
        mdeTechnologyClonedRepoEntriesForFileCounter0 = new MdeTechnologyClonedRepoEntriesForFileCounter((Workflow) null);
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForFileCounter", e);
      }
  }
}
