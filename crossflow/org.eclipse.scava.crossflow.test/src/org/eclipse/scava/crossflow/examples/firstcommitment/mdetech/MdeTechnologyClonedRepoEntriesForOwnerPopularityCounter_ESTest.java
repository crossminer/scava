...
public class MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter_ESTest extends MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter mdeTechnologyClonedRepoEntriesForOwnerPopularityCounter0 = null;
          try {
            mdeTechnologyClonedRepoEntriesForOwnerPopularityCounter0 = new MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter(mdeTechnologyExample0);
            fail("Expecting exception: JMSException");
             ...
             // org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter.<init>(MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter.java:31)
  ...
  public void test1()  throws Throwable  {
      MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter mdeTechnologyClonedRepoEntriesForOwnerPopularityCounter0 = null;
      try {
        mdeTechnologyClonedRepoEntriesForOwnerPopularityCounter0 = new MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter((Workflow) null);
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter", e);
      }
  }
}
