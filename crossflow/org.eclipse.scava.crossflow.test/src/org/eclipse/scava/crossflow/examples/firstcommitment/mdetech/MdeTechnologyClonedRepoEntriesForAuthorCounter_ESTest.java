...
public class MdeTechnologyClonedRepoEntriesForAuthorCounter_ESTest extends MdeTechnologyClonedRepoEntriesForAuthorCounter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          MdeTechnologyClonedRepoEntriesForAuthorCounter mdeTechnologyClonedRepoEntriesForAuthorCounter0 = null;
          try {
            mdeTechnologyClonedRepoEntriesForAuthorCounter0 = new MdeTechnologyClonedRepoEntriesForAuthorCounter(mdeTechnologyExample0);
            fail("Expecting exception: JMSException");
             ...
             // org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForAuthorCounter.<init>(MdeTechnologyClonedRepoEntriesForAuthorCounter.java:31)
  ...
  public void test1()  throws Throwable  {
      MdeTechnologyClonedRepoEntriesForAuthorCounter mdeTechnologyClonedRepoEntriesForAuthorCounter0 = null;
      try {
        mdeTechnologyClonedRepoEntriesForAuthorCounter0 = new MdeTechnologyClonedRepoEntriesForAuthorCounter((Workflow) null);
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.eclipse.scava.crossflow.examples.firstcommitment.mdetech.MdeTechnologyClonedRepoEntriesForAuthorCounter", e);
      }
  }
}
