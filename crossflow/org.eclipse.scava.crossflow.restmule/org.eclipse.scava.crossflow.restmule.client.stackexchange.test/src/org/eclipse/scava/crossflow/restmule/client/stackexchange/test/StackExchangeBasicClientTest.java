...
public class StackExchangeBasicClientTest extends StackExchangeUtils {

	private static final Logger LOG = LogManager.getLogger(StackExchangeBasicClientTest.class);
...
//		StackExchangeUtils.forceLocalCaching(true);
		...
		api = StackExchangeApi.create().setSession(basicSession).build();
//		api = StackExchangeUtils.getBasicClient();
	}
	
//	@Before
//	public void clearCache() {
//		StackExchangeUtils.clearStackExchangeCache();
//	}
	...
	public void testSessionAnswers() {
		...
		String sort = "votes";
		Integer fromdate = 1535760000;
		Integer todate = 1535765000; // total = 141
		String filter = null;// "";
		String callback = null;// ""
		String site = "stackoverflow";
