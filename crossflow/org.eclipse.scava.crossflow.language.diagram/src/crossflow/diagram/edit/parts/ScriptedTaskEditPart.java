...
import crossflow.diagram.edit.policies.ScriptedTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ScriptedTaskEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ScriptedTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ScriptedTaskItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new ScriptedTaskFigure();
	}

	/**
	* @generated
	*/
	public ScriptedTaskFigure getPrimaryShape() {
		return (ScriptedTaskFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ScriptedTaskNameEditPart) {
			((ScriptedTaskNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureScriptedTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof ScriptedTaskScriptedTaskOutputVariablesCompartmentEditPart) {
			...
			pane.add(((ScriptedTaskScriptedTaskOutputVariablesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ScriptedTaskScriptedTaskOutputVariablesCompartmentEditPart) {
			return getPrimaryShape().getScriptedTaskOutputVariablesCompartmentFigure();
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(ScriptedTaskNameEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class ScriptedTaskFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureScriptedTaskLabelFigure() {
			return fFigureScriptedTaskLabelFigure;
		}
