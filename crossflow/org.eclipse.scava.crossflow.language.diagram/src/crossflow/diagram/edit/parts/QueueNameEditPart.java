 ...
 * @generated
 */
public class QueueNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QueueNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.Queue_2004, getParserElement(),
					CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.QueueNameEditPart.VISUAL_ID));
		}
		return parser;
	}
