...
public class WrappingLabel4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.TypeExtending_4004, getParserElement(),
