...
import crossflow.diagram.edit.commands.CrossflowCreateShortcutDecorationsCommand;
import crossflow.diagram.edit.policies.WorkflowCanonicalEditPolicy;
import crossflow.diagram.edit.policies.WorkflowItemSemanticEditPolicy;
...
public class WorkflowEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Crossflow"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WorkflowItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new WorkflowCanonicalEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new CrossflowCreateShortcutDecorationsCommand(getEditingDomain(),
