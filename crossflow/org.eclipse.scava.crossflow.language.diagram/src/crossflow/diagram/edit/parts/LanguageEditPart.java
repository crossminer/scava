...
import crossflow.diagram.edit.policies.LanguageItemSemanticEditPolicy;
...
public class LanguageEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LanguageNameEditPart) {
			((LanguageNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLanguageLabelFigure());
			return true;
		}
		if (childEditPart instanceof LanguageLanguageParametersCompartmentEditPart) {
			...
			pane.add(((LanguageLanguageParametersCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof LanguageLanguageParametersCompartmentEditPart) {
			return getPrimaryShape().getLanguageParametersCompartmentFigure();
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(LanguageNameEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class LanguageFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fLanguageParametersCompartmentFigure;
		 ...
		 * @generated
		 */
		public RectangleFigure getLanguageParametersCompartmentFigure() {
			return fLanguageParametersCompartmentFigure;
		}
