...
import crossflow.diagram.edit.policies.CsvSourceItemSemanticEditPolicy;
import crossflow.diagram.part.CrossflowVisualIDRegistry;

/**
 * @generated
 */
public class CsvSourceEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CsvSourceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CsvSourceItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new CsvSourceFigure();
	}

	/**
	* @generated
	*/
	public CsvSourceFigure getPrimaryShape() {
		return (CsvSourceFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CsvSourceNameEditPart) {
			((CsvSourceNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCsvSourceLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(CsvSourceNameEditPart.VISUAL_ID));
	}
	...
	*/
	...
	public class CsvSourceFigure extends ScalablePolygonShape {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureCsvSourceLabelFigure;
		...
		private void createContents() {
			...
			fFigureCsvSourceLabelFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureCsvSourceLabelFigure() {
			return fFigureCsvSourceLabelFigure;
		}
