...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.TaskOutput_4003, getParserElement(),
