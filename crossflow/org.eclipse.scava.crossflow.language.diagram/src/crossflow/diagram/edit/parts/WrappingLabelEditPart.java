...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.StreamType_4001, getParserElement(),
