...
import crossflow.diagram.edit.policies.DataFieldItemSemanticEditPolicy;
import crossflow.diagram.part.CrossflowVisualIDRegistry;

/**
 * @generated
 */
public class DataFieldEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DataFieldEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataFieldItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataFieldNameTypeEditPart) {
			((DataFieldNameTypeEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(DataFieldNameTypeEditPart.VISUAL_ID));
	}
