 ...
 * @generated
 */
public class ReusableComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ReusableComponentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.ReusableComponent_2017, getParserElement(),
					CrossflowVisualIDRegistry
							.getType(crossflow.diagram.edit.parts.ReusableComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CrossflowEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
