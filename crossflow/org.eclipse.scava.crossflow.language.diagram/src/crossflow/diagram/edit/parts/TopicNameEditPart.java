...
public class TopicNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.Topic_2003, getParserElement(),
					CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.TopicNameEditPart.VISUAL_ID));
		}
		return parser;
	}
