 ...
 * @generated
 */
public class ParameterNameValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParameterNameValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.Parameter_3002, getParserElement(),
					CrossflowVisualIDRegistry
							.getType(crossflow.diagram.edit.parts.ParameterNameValueEditPart.VISUAL_ID));
		}
		return parser;
	}
