 ...
 * @generated
 */
public class DataFieldNameType2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataFieldNameType2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.DataField_3006, getParserElement(),
					CrossflowVisualIDRegistry
							.getType(crossflow.diagram.edit.parts.DataFieldNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
