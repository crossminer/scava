...
import crossflow.diagram.edit.policies.ParameterItemSemanticEditPolicy;
...
public class ParameterEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParameterNameValueEditPart) {
			((ParameterNameValueEditPart) childEditPart).setLabel(getPrimaryShape().getFigureParameterLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(ParameterNameValueEditPart.VISUAL_ID));
	}
