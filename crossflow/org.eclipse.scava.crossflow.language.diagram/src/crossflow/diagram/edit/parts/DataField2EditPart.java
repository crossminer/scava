...
import crossflow.diagram.edit.policies.DataField2ItemSemanticEditPolicy;
import crossflow.diagram.part.CrossflowVisualIDRegistry;

/**
 * @generated
 */
public class DataField2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DataField2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataField2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataFieldNameType2EditPart) {
			((DataFieldNameType2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(DataFieldNameType2EditPart.VISUAL_ID));
	}
