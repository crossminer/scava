...
import crossflow.diagram.edit.policies.DataField3ItemSemanticEditPolicy;
import crossflow.diagram.part.CrossflowVisualIDRegistry;

/**
 * @generated
 */
public class DataField3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DataField3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataField3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataFieldNameType3EditPart) {
			((DataFieldNameType3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrossflowVisualIDRegistry.getType(DataFieldNameType3EditPart.VISUAL_ID));
	}
	...
	public class DataFieldFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureDataFieldLabelFigure.setText("DataField");
