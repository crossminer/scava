 ...
 * @generated
 */
public class OpinionatedTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OpinionatedTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.OpinionatedTask_2008, getParserElement(),
					CrossflowVisualIDRegistry
							.getType(crossflow.diagram.edit.parts.OpinionatedTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
