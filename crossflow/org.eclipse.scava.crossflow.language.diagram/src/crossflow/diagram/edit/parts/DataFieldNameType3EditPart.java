 ...
 * @generated
 */
public class DataFieldNameType3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataFieldNameType3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.DataField_3008, getParserElement(),
					CrossflowVisualIDRegistry
							.getType(crossflow.diagram.edit.parts.DataFieldNameType3EditPart.VISUAL_ID));
		}
		return parser;
	}
