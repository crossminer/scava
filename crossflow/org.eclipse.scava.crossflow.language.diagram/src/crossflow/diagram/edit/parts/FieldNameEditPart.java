...
public class FieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrossflowParserProvider.getParser(CrossflowElementTypes.Field_2008, getParserElement(),
					CrossflowVisualIDRegistry.getType(crossflow.diagram.edit.parts.FieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
