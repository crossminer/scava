 ...
 * @generated
 */
public class LanguageLanguageParametersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrossflowPackage.eINSTANCE.getLanguage_Parameters();
	}
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ParameterEditPart.VISUAL_ID == CrossflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<CrossflowNodeDescriptor> descriptorsIterator = childDescriptors.iterator(); descriptorsIterator
				.hasNext();) {
			CrossflowNodeDescriptor next = descriptorsIterator.next();
			String hint = CrossflowVisualIDRegistry.getType(next.getVisualID());
		...
		for (CrossflowNodeDescriptor next : childDescriptors) {
			String hint = CrossflowVisualIDRegistry.getType(next.getVisualID());
