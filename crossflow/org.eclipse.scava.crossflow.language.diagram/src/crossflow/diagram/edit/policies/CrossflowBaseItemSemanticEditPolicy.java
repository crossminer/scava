 ...
 * @generated
 */
public class CrossflowBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected CrossflowBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = CrossflowElementTypes.getElementType(getVisualID(request));
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = CrossflowDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			CrossflowDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		* @generated
		*/
		public boolean canCreateStreamType_4001(Stream source, Type target) {
			if (source != null) {
			...
			return canExistStreamType_4001(source, target);
		}
		...
		*/
		public boolean canCreateTypeExtending_4004(Type source, Type target) {
			...
			return canExistTypeExtending_4004(source, target);
		}

		/**
		* @generated
		*/
		public boolean canExistStreamType_4001(Stream source, Type target) {
			return true;
		}
		...
		* @generated
		*/
		public boolean canExistTypeExtending_4004(Type source, Type target) {
			return true;
		}
	}
