 ...
 * @generated
 */
public class TaskOutputReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TaskOutputReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return CrossflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistTaskOutput_4003(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return CrossflowBaseItemSemanticEditPolicy.getLinkConstraints().canExistTaskOutput_4003(getOldSource(),
				getNewTarget());
	}
