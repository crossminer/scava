...
public class TopicCreateCommand extends EditElementCommand {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Topic newElement = CrossflowFactory.eINSTANCE.createTopic();

		Workflow owner = (Workflow) getElementToEdit();
		owner.getStreams().add(newElement);
	...
	* @generated
	*/
	protected void doConfigure(Topic newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
