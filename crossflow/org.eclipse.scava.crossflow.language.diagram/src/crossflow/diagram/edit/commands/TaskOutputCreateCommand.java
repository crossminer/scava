 ...
 * @generated
 */
public class TaskOutputCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TaskOutputCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return CrossflowBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTaskOutput_4003(getSource(),
				getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getOutput().add(getTarget());
		}
