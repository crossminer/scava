 ...
 * @generated
 */
public class QueueCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public QueueCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Queue newElement = CrossflowFactory.eINSTANCE.createQueue();
