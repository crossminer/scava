 ...
 * @generated
 */
public class StreamTypeCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public StreamTypeCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return CrossflowBaseItemSemanticEditPolicy.getLinkConstraints().canCreateStreamType_4001(getSource(),
				getTarget());
	}
