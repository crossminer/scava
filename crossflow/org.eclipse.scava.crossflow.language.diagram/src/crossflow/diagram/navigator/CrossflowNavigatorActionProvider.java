...
import crossflow.diagram.part.CrossflowDiagramEditor;
 ...
 * @generated
 */
public class CrossflowNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CrossflowDiagramEditor.ID);
			} catch (PartInitException e) {
				CrossflowDiagramEditorPlugin.getInstance().logError("Exception while openning diagram", e); //$NON-NLS-1$
			}
		}
