 ...
 * @generated
 */
public class CrossflowDomainNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public CrossflowDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof CrossflowDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((CrossflowDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new CrossflowDomainNavigatorItem((EObject) objects[i], parentElement,
