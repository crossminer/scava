...
import crossflow.diagram.providers.CrossflowMarkerNavigationProvider;
import crossflow.diagram.providers.CrossflowValidationProvider;
...
public class ValidateAction extends Action {
	...
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		CrossflowMarkerNavigationProvider.addMarker(target, elementId, location, message, statusSeverity);
	}
