...
if __name__ == '__main__':
	...
	parser.add_argument('-name', default='Word Count Example', help='The name of the workflow')
	...
	parser.add_argument('-instance', default='Word Count Example', help='The instance of the master (to contribute to)')
