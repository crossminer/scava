...
function createTask(name, graph, parent) {
	var id = 'task_' + name;
    var v = graph.insertVertex(parent, id, name, 20, 20, 80, 30, 'fontSize=16;fontColor=black;strokeColor=black;fillColor=#ffffff');	graph.updateCellSize(v, true);
	return v;
}
...
function createStream(name, graph, parent) {
	...
	v.style = "shape=Direct Data;fontSize=16;fontColor=black;strokeColor=black;fillColor=#ffffff";
