...
public class MdeTechnologyRepoFileCountEntries implements Channel {
	...
	public MdeTechnologyRepoFileCountEntries(Workflow workflow) throws Exception {
		...
		pre.put("MdeTechnologyRepoFileCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesPre.MdeTechnologyRepoFileCountCsvSink"));
		destination.put("MdeTechnologyRepoFileCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesDestination.MdeTechnologyRepoFileCountCsvSink"));
		post.put("MdeTechnologyRepoFileCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesPost.MdeTechnologyRepoFileCountCsvSink"));
	...
	public void send(ExtensionKeywordStargazersRemoteRepoUrlLocalRepoPathTuple extensionKeywordStargazersRemoteRepoUrlLocalRepoPathTuple, String taskId) {
		try {
			...
			if ((d = pre.get(taskId)) != null) {
				...
				extensionKeywordStargazersRemoteRepoUrlLocalRepoPathTuple.setDestination("MdeTechnologyRepoFileCountEntries");
	...
	public void addConsumer(MdeTechnologyRepoFileCountEntriesConsumer consumer, String consumerId) throws Exception {
						...
						if (workflow.isCacheEnabled() && workflow.getCache().hasCachedOutputs(job)) {
							for (Job output : workflow.getCache().getCachedOutputs(job)) {
								if (output.getDestination().equals("MdeTechnologyRepoFileCountEntries")) {
									...
									System.err.println(
											output.getDestination() + " destination found in MdeTechnologyRepoFileCountEntries pre consumer");
								}
							}
						} else {
		...
		messageConsumer.setMessageListener(new MessageListener() {
			...
			public void onMessage(Message message) {
				...
				try {
					...
					consumer.consumeMdeTechnologyRepoFileCountEntriesActual(extensionKeywordStargazersRemoteRepoUrlLocalRepoPathTuple);
