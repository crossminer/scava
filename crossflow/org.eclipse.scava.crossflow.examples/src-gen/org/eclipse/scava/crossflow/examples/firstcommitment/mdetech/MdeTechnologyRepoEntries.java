...
public class MdeTechnologyRepoEntries {
	...
	public void send(ExtensionKeywordStargazersTuple extensionKeywordStargazersTuple, String taskId) {
		try {
			Destination d = null;
	...
	public void addConsumer(MdeTechnologyRepoEntriesConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologyRepoEntriesPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologyRepoEntriesDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologyRepoEntriesPost-" + consumerId);
