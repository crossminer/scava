...
public class MdeTechnologyClonedRepoEntriesForFileCounter {
	...
	public void addConsumer(MdeTechnologyClonedRepoEntriesForFileCounterConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForFileCounterPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForFileCounterDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForFileCounterPost-" + consumerId);
