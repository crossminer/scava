...
public class MdeTechnologyRepoOwnerPopularityCountEntries implements Channel {
	...
	public MdeTechnologyRepoOwnerPopularityCountEntries(Workflow workflow) throws Exception {
		...
		pre.put("MdeTechnologyRepoOwnerPopularityCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesPre.MdeTechnologyRepoOwnerPopularityCountPrinter"));
		destination.put("MdeTechnologyRepoOwnerPopularityCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesDestination.MdeTechnologyRepoOwnerPopularityCountPrinter"));
		post.put("MdeTechnologyRepoOwnerPopularityCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesPost.MdeTechnologyRepoOwnerPopularityCountPrinter"));
	...
	public void addConsumer(MdeTechnologyRepoOwnerPopularityCountEntriesConsumer consumer, String consumerId) throws Exception {
						...
						if (workflow.isCacheEnabled() && workflow.getCache().hasCachedOutputs(job)) {
							for (Job output : workflow.getCache().getCachedOutputs(job)) {
								if (output.getDestination().equals("MdeTechnologyRepoOwnerPopularityCountEntries")) {
									...
									System.err.println(
											output.getDestination() + " destination found in MdeTechnologyRepoOwnerPopularityCountEntries pre consumer");
								}
							}
						} else {
