...
public class MdeTechnologyRepoOwnerPopularityCountEntries {
	...
	public void addConsumer(MdeTechnologyRepoOwnerPopularityCountEntriesConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologyRepoOwnerPopularityCountEntriesPost-" + consumerId);
