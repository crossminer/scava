...
public class ResultsPublisher2 implements Channel {
	...
	public ResultsPublisher2(Workflow workflow) throws Exception {
		...
		pre.put("EmptySink2", (ActiveMQDestination) session.createQueue("ResultsPublisher2Pre.EmptySink2"));
		destination.put("EmptySink2", (ActiveMQDestination) session.createQueue("ResultsPublisher2Destination.EmptySink2"));
		post.put("EmptySink2", (ActiveMQDestination) session.createQueue("ResultsPublisher2Post.EmptySink2"));
