...
public class ResultsPublisher2 {
	...
	public void addConsumer(ResultsPublisher2Consumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("ResultsPublisher2Pre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("ResultsPublisher2Destination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("ResultsPublisher2Post-" + consumerId);
