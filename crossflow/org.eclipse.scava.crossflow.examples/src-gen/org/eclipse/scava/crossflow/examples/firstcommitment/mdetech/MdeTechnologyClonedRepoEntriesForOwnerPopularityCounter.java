...
public class MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter {
	...
	public MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter(Workflow workflow) throws Exception {
		...
		destination = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter");
		pre = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterPre");
		post = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterPost");
	...
	public void send(ExtensionKeywordStargazersRemoteRepoUrlTuple extensionKeywordStargazersRemoteRepoUrlTuple) {
		try {
			...
			extensionKeywordStargazersRemoteRepoUrlTuple.setDestination("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter");
	...
	public void addConsumer(MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterConsumer consumer) throws Exception {
