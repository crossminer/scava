...
public class AdditionResults {
	...
	public AdditionResults(Workflow workflow) throws Exception {
		...
		destination = session.createQueue("AdditionResults");
		pre = session.createQueue("AdditionResultsPre");
		post = session.createQueue("AdditionResultsPost");
	...
	public void addConsumer(AdditionResultsConsumer consumer) throws Exception {
