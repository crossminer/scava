...
public class AdditionResults implements Channel {
	...
	public AdditionResults(Workflow workflow) throws Exception {
		...
		pre.put("Printer", (ActiveMQDestination) session.createQueue("AdditionResultsPre.Printer"));
		destination.put("Printer", (ActiveMQDestination) session.createQueue("AdditionResultsDestination.Printer"));
		post.put("Printer", (ActiveMQDestination) session.createQueue("AdditionResultsPost.Printer"));
