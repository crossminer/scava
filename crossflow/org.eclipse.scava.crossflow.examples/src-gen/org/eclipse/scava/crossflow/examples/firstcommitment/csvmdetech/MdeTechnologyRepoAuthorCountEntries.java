...
public class MdeTechnologyRepoAuthorCountEntries implements Channel {
	...
	public MdeTechnologyRepoAuthorCountEntries(Workflow workflow) throws Exception {
		...
		pre.put("MdeTechnologyRepoAuthorCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesPre.MdeTechnologyRepoAuthorCountCsvSink"));
		destination.put("MdeTechnologyRepoAuthorCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesDestination.MdeTechnologyRepoAuthorCountCsvSink"));
		post.put("MdeTechnologyRepoAuthorCountCsvSink", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesPost.MdeTechnologyRepoAuthorCountCsvSink"));
			...
			messageConsumer.setMessageListener(new MessageListener() {
				...
				public void onMessage(Message message) {
					...
					try {
						...
						consumer.consumeMdeTechnologyRepoAuthorCountEntriesWithNotifications(extensionKeywordStargazersRemoteRepoUrlLocalRepoPathTuple);
