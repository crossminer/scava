...
public class MdeTechnologyRepoFileCountEntries implements Channel {
	...
	public MdeTechnologyRepoFileCountEntries(Workflow workflow) throws Exception {
		...
		pre.put("MdeTechnologyRepoFileCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesPre.MdeTechnologyRepoFileCountPrinter"));
		destination.put("MdeTechnologyRepoFileCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesDestination.MdeTechnologyRepoFileCountPrinter"));
		post.put("MdeTechnologyRepoFileCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoFileCountEntriesPost.MdeTechnologyRepoFileCountPrinter"));
