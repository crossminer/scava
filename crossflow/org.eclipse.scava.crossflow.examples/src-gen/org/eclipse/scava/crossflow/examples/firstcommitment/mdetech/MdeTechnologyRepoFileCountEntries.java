...
public class MdeTechnologyRepoFileCountEntries {
	...
	public void addConsumer(MdeTechnologyRepoFileCountEntriesConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologyRepoFileCountEntriesPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologyRepoFileCountEntriesDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologyRepoFileCountEntriesPost-" + consumerId);
