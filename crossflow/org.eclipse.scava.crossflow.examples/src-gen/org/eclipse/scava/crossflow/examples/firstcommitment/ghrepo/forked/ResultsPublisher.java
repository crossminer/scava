...
public class ResultsPublisher {
	...
	public void addConsumer(ResultsPublisherConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("ResultsPublisherPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("ResultsPublisherDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("ResultsPublisherPost-" + consumerId);
