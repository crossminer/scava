...
public class MdeTechnologies {
	...
	public void addConsumer(MdeTechnologiesConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologiesPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologiesDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologiesPost-" + consumerId);
