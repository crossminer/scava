...
public class MdeTechnologies implements Channel{
	...
	public void addConsumer(MdeTechnologiesConsumer consumer, String consumerId) throws Exception {
		...
		ActiveMQDestination preQueue = (ActiveMQDestination) session.createQueue("MdeTechnologiesPre." + consumerId);
		pre.put(consumerId, preQueue);	
	
		ActiveMQDestination destQueue = (ActiveMQDestination) session.createQueue("MdeTechnologiesDestination." + consumerId);
		destination.put(consumerId, destQueue);	
	
		ActiveMQDestination postQueue = (ActiveMQDestination) session.createQueue("MdeTechnologiesPost." + consumerId);
