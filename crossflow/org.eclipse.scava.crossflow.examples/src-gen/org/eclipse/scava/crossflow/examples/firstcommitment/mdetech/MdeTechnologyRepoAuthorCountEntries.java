...
public class MdeTechnologyRepoAuthorCountEntries implements Channel {
	...
	public MdeTechnologyRepoAuthorCountEntries(Workflow workflow) throws Exception {
		...
		pre.put("MdeTechnologyRepoAuthorCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesPre.MdeTechnologyRepoAuthorCountPrinter"));
		destination.put("MdeTechnologyRepoAuthorCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesDestination.MdeTechnologyRepoAuthorCountPrinter"));
		post.put("MdeTechnologyRepoAuthorCountPrinter", (ActiveMQDestination) session.createQueue("MdeTechnologyRepoAuthorCountEntriesPost.MdeTechnologyRepoAuthorCountPrinter"));
