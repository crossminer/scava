...
public class MdeTechnologyRepoAuthorCountEntries {
	...
	public MdeTechnologyRepoAuthorCountEntries(Workflow workflow) throws Exception {
		...
		destination = session.createQueue("MdeTechnologyRepoAuthorCountEntries");
		pre = session.createQueue("MdeTechnologyRepoAuthorCountEntriesPre");
		post = session.createQueue("MdeTechnologyRepoAuthorCountEntriesPost");
	...
	public void send(StringStringIntegerStringIntegerTuple stringStringIntegerStringIntegerTuple) {
		try {
			...
			stringStringIntegerStringIntegerTuple.setDestination("MdeTechnologyRepoAuthorCountEntries");
	...
	public void addConsumer(MdeTechnologyRepoAuthorCountEntriesConsumer consumer) throws Exception {
