...
public class Animals {
	...
	public void addConsumer(AnimalsConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("AnimalsPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("AnimalsDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("AnimalsPost-" + consumerId);
