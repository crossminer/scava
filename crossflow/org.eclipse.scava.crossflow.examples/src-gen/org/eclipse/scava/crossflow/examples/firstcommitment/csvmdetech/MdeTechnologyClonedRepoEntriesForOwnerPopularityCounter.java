...
public class MdeTechnologyClonedRepoEntriesForOwnerPopularityCounter {
	...
	public void addConsumer(MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterConsumer consumer, String consumerId) throws Exception {
		...
		Destination preQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterPre-" + consumerId);
		pre.put(consumerId, preQueue);	
	
		Destination destQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterDestination-" + consumerId);
		destination.put(consumerId, destQueue);	
	
		Destination postQueue = session.createQueue("MdeTechnologyClonedRepoEntriesForOwnerPopularityCounterPost-" + consumerId);
