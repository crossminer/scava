 ...
 * @generated
 */
public class CrossflowSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CrossflowPackage.WORKFLOW: {
				Workflow workflow = (Workflow)theEObject;
				T result = caseWorkflow(workflow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CrossflowPackage.STREAM: {
				Stream stream = (Stream)theEObject;
				T result = caseStream(stream);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CrossflowPackage.TOPIC: {
				Topic topic = (Topic)theEObject;
				T result = caseTopic(topic);
				if (result == null) result = caseStream(topic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CrossflowPackage.QUEUE: {
				Queue queue = (Queue)theEObject;
				T result = caseQueue(queue);
				if (result == null) result = caseStream(queue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CrossflowPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CrossflowPackage.SOURCE: {
				Source source = (Source)theEObject;
				T result = caseSource(source);
				if (result == null) result = caseTask(source);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
