 ...
 *   <li>{@link crossflow.Field#getType <em>Type</em>}</li>
 *   <li>{@link crossflow.Field#isMany <em>Many</em>}</li>
 * </ul>
 *
 * @see crossflow.CrossflowPackage#getField()
 * @model annotation="gmf.node label='name' label.pattern='{0}' label.icon='false'"
 * @generated
 */
public interface Field extends EObject {
	 ...
	 * @see #setType(String)
	 * @see crossflow.CrossflowPackage#getField_Type()
	...
	/**
	 * Sets the value of the '{@link crossflow.Field#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
