...
public class CrossflowComponentsFactoryImpl extends EFactoryImpl implements CrossflowComponentsFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case CrossflowComponentsPackage.COMPONENT_TYPES:
				return createComponentTypesFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case CrossflowComponentsPackage.COMPONENT_TYPES:
				return convertComponentTypesToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ComponentTypes createComponentTypesFromString(EDataType eDataType, String initialValue) {
		ComponentTypes result = ComponentTypes.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertComponentTypesToString(EDataType eDataType, Object instanceValue) {
