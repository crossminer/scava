/**
 */
package crossflowComponents.provider;
...
/**
 * This is the item provider adapter for a {@link crossflowComponents.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_fullyQualifiedName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_fullyQualifiedName_feature", "_UI_Component_type"),
				 CrossflowComponentsPackage.Literals.COMPONENT__FULLY_QUALIFIED_NAME,
				 true,
				 false,
				 false,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_language_feature", "_UI_Component_type"),
				 CrossflowComponentsPackage.Literals.COMPONENT__LANGUAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CrossflowComponentsPackage.Literals.COMPONENT__CONSUMES);
			childrenFeatures.add(CrossflowComponentsPackage.Literals.COMPONENT__PRODUCES);
		}
	...
	public String getText(Object object) {
		String label = ((Component)object).getFullyQualifiedName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CrossflowComponentsPackage.Literals.COMPONENT__CONSUMES,
				 CrossflowFactory.eINSTANCE.createType()));

		newChildDescriptors.add
			(createChildParameter
				(CrossflowComponentsPackage.Literals.COMPONENT__PRODUCES,
				 CrossflowFactory.eINSTANCE.createType()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == CrossflowComponentsPackage.Literals.COMPONENT__CONSUMES ||
			childFeature == CrossflowComponentsPackage.Literals.COMPONENT__PRODUCES;
