...
/**
 * This is the item provider adapter for a {@link crossflow.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider 
	...
	protected void addExtendingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_extending_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_extending_feature", "_UI_Type_type"),
				 CrossflowPackage.Literals.TYPE__EXTENDING,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CrossflowPackage.Literals.TYPE__FIELDS);
		}
