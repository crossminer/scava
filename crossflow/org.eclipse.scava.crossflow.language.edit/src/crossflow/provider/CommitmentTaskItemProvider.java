...
/**
 * This is the item provider adapter for a {@link crossflow.CommitmentTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommitmentTaskItemProvider extends TaskItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CommitmentTaskItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCommitAfterPropertyDescriptor(object);
		}
	...
	public String getText(Object object) {
		String label = ((CommitmentTask)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CommitmentTask_type") :
			getString("_UI_CommitmentTask_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CommitmentTask.class)) {
