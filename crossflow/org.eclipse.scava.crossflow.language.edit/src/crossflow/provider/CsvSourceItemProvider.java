...
/**
 * This is the item provider adapter for a {@link crossflow.CsvSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CsvSourceItemProvider extends SourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CsvSourceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CsvSource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CsvSource_type") :
			getString("_UI_CsvSource_type") + " " + label;
	}
