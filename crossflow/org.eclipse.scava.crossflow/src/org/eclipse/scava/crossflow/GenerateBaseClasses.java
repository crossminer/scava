...
public class GenerateBaseClasses {
	...
	public void run(String projectLocation, String modelName) throws Exception {

		this.projectLocation = projectLocation;
		crossflowDiagramModelName = modelName;
	...
	public List<IModel> getModels() throws Exception {
		...
		models.add(createAndLoadAnEmfModel("org.eclipse.scava.crossflow",
				projectLocation + File.separator + "model" + File.separator + crossflowDiagramModelName, "Model", true,
				false, false));
