...
public class ResultsBroadcaster implements Channel {
	...
	public ResultsBroadcaster(Workflow workflow) throws Exception {
		...
		destination = (ActiveMQDestination) session.createTopic("ResultsBroadcaster");
	...
	public ActiveMQDestination getTopic() {
		return destination;
	}
