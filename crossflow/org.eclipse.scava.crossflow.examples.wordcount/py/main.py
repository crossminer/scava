...
from crossflow.wordcount.word_count_workflow import WordCountWorkflow
...
if __name__ == '__main__':
    ...
    parser.add_argument('-instance', default='WordCountWorkflow', help='The instance of the master (to contribute to)')
    ...
    app = WordCountWorkflow(name=parsedArgs.name,
