...
public class Additions implements Channel {
	...
	public Additions(Workflow workflow) throws Exception {
		...
		pre.put("Adder", (ActiveMQDestination) session.createQueue("AdditionsPre.Adder"));
		destination.put("Adder", (ActiveMQDestination) session.createQueue("AdditionsDestination.Adder"));
		post.put("Adder", (ActiveMQDestination) session.createQueue("AdditionsPost.Adder"));
