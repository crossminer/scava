...
public class Urls implements Channel {
	...
	public Urls(Workflow workflow) throws Exception {
		...
		pre.put("UrlCollector", (ActiveMQDestination) session.createQueue("UrlsPre.UrlCollector"));
		destination.put("UrlCollector", (ActiveMQDestination) session.createQueue("UrlsDestination.UrlCollector"));
		post.put("UrlCollector", (ActiveMQDestination) session.createQueue("UrlsPost.UrlCollector"));
