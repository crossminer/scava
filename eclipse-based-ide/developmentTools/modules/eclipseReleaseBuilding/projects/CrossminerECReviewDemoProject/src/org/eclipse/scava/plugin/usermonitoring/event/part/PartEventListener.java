...
public class PartEventListener implements IEventListener, IPartListener2 {
	...
	public void partActivated(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.ACTIVATED));
	...
	public void partBroughtToTop(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.BROUGHT_TO_TOP));

	}

	@Override
	public void partClosed(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.CLOSED));

	}

	@Override
	public void partDeactivated(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.DEACTIVATED));
	...
	public void partOpened(IWorkbenchPartReference partRef) {
		...
		EventManager.processEvent(new PartEvent(partRef, PartEventType.OPENED));
	}

	@Override
	public void partHidden(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.HIDDEN));

	}

	@Override
	public void partVisible(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.VISIBLE));

	}

	@Override
	public void partInputChanged(IWorkbenchPartReference partRef) {
		EventManager.processEvent(new PartEvent(partRef, PartEventType.INPUT_CHANGED));
