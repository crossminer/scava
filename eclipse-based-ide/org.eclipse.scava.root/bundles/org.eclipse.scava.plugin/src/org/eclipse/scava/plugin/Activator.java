...
public class Activator extends AbstractUIPlugin {
	...
	public Activator() {
		...
		eventBus = new EventBus((exception, context) -> {
			System.out.println("EventBusSubscriberException: " + exception + " | " + "BUS:" + context.getEventBus() + " EVENT: " + context.getEvent() + " SUBSRIBER: " + context.getSubscriber() + " METHOD: "
	...
	private void startMainMVC() {
		...
		mainController = new MainController(null, model, eventBus);
		mainController.init();
	}
