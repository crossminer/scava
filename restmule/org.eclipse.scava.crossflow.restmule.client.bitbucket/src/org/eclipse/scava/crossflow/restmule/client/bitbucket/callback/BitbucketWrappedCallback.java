package org.eclipse.scava.crossflow.restmule.client.bitbucket.callback;
...
public class BitbucketWrappedCallback<D,R extends IWrap<D>> extends AbstractWrappedCallback<D,R, BitbucketDataSet<D>>  {

	private static final Logger LOG = LogManager.getLogger(BitbucketWrappedCallback.class);
	
	private static BitbucketPagination paginationPolicy = BitbucketPagination.get();
	
	public BitbucketWrappedCallback() {
		super(new BitbucketDataSet<D>());
	}
	...
	public Integer totalIterations(Response<R> response) { // FIXME
		...
		String pagination = BitbucketPropertiesUtil.get(PAGE_INFO);
		String headerValue;
