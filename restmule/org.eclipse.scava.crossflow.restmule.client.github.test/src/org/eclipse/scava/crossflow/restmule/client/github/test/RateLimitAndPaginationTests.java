...
public class RateLimitAndPaginationTests extends GitHubUtils {
	...
	@Test
	public void testSmallPagedRequestForWrapped() {
		// Number of total results: ~107 
		Long count = api.getSearchCode("asc", "texttransformation extension:m2t", "indexed").observe().count().blockingGet();
		assertTrue(count > 100);
	}
