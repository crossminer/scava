...
public class RepoPalCompoundSimilarityCalculatorV2 implements ISingleSimilarityCalculator {
	...
	private static final Logger logger = LoggerFactory.getLogger(RepoPalCompoundSimilarityCalculatorV2.class);
	...
	public double calculateSimilarity(Artifact prj1, Artifact prj2) {
		...
		return (readme + star + time) / 3.0;
	}

	@Override
	public String getSimilarityName() {
		return "RepoPalCompoundV2";
	}
	@Override
