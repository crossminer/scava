...
public class CROSSRecServiceImpl implements IRecommendationProvider {
	...
	/*
	 * Recommends libraries to an input project using the user-based
	 * collaborative-filtering technique
	 */
	public Map<String, Double> userBasedRecommendation(List<Dependency> dependencies, Map<String, Double> sim) {
		Set<String> depsStringSet = dependencies.stream().map(z -> z.getGroupID() + ":" + z.getArtifactID())
		 ...
		 */
		libraries.addAll(dependencies.stream().map(z -> z.getGroupID() + ":" + z.getArtifactID()).collect(Collectors.toList()));
