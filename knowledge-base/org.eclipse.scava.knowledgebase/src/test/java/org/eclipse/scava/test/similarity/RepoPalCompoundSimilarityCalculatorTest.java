...
public class RepoPalCompoundSimilarityCalculatorTest {
	@Autowired
	private ArtifactRepository artifactRepository;
	@Autowired
	@Qualifier("RepoPalCompound")
	private ISingleSimilarityCalculator repoPalCompoundSim;
	private static final Logger logger = LoggerFactory.getLogger(RepoPalCompoundSimilarityCalculatorTest.class);
	...
	public void crossSimCommutativeTest() {
		double val1 = repoPalCompoundSim.calculateSimilarity(artifact1, artifact2);
		double val2 = repoPalCompoundSim.calculateSimilarity(artifact2, artifact1);
...
//		double val1 = repoPalCompoundSim.calculateSimilarity(artifacts.get(0), artifacts.get(0));
