...
public class NntpNewsGroup extends org.eclipse.crossmeter.repository.model.CommunicationChannel {
	
	
	
	public NntpNewsGroup() { 
		super();
		super.setSuperTypes("org.eclipse.crossmeter.repository.model.cc.nntp.CommunicationChannel");
		AUTHENTICATIONREQUIRED.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		USERNAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		PASSWORD.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		PORT.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		DESCRIPTION.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		NAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		INTERVAL.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		LASTARTICLECHECKED.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.nntp.NntpNewsGroup");
	}
