...
public class ZendeskManager implements ICommunicationChannelManager<Zendesk> {
	...
	public CommunicationChannelDelta getDelta(DB db,
		...
		org.eclipse.crossmeter.platform.communicationchannel.zendesk.Zendesk zendesk;
		zendesk = new org.eclipse.crossmeter.platform.communicationchannel.zendesk.Zendesk.Builder(
				...
				for (Ticket tk : tickets) {
					...
					if (javaTicketDate != null) {
						...
						if (date.compareTo(articleDate) < 0) {
							...
							org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk zenDesk = new org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk();
