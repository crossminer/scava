...
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Attachment;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Audit;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Comment;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Field;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Forum;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Group;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.GroupMembership;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Identity;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Organization;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.OrganizationField;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.SearchResultEntity;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Status;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Ticket;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Topic;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.User;
import org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.UserField;
...
public class Zendesk implements Closeable {
    ...
    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getRequests() {
        return new PagedIterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests.json"),
                handleList(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getOpenRequests() {
        return new PagedIterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/open.json"),
                handleList(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getSolvedRequests() {
        return new PagedIterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/solved.json"),
                handleList(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getCCRequests() {
        return new PagedIterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request>(cnst("/requests/ccd.json"),
                handleList(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getUserRequests(User user) {
        checkHasId(user);
        return getUserRequests(user.getId());
    }

    public Iterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request> getUserRequests(long id) {
        return new PagedIterable<org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request>(tmpl("/users/{id}/requests.json").set("id", id),
                handleList(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "requests"));
    }

    public org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request getRequest(long id) {
        return complete(submit(req("GET", tmpl("/requests/{id}.json").set("id", id)),
                handle(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "request")));
    }

    public org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request createRequest(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request) {
        return complete(submit(req("POST", cnst("/requests.json"),
                        JSON, json(Collections.singletonMap("request", request))),
                handle(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request.class, "request")));
    }

    public org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request updateRequest(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request) {
        checkHasId(request);
    ...
    public Iterable<Comment> getRequestComments(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request) {
        checkHasId(request);
    ...
    public Comment getRequestComment(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request, Comment comment) {
        checkHasId(comment);
        return getRequestComment(request, comment.getId());
    }

    public Comment getRequestComment(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request, long commentId) {
        checkHasId(request);
    ...
    private static void checkHasId(org.eclipse.crossmeter.platform.communicationchannel.zendesk.model.Request request) {
