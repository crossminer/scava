...
public abstract class Request extends Tracker {
	...
	protected org.eclipse.crossmeter.repository.model.Person creator = null;
	...
	public Request() { 
		...
		LOCATION.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.Request");
		STATUS.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.Request");
		SUMMARY.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.Request");
		CREATED_AT.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.Request");
		UPDATED_AT.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.Request");
	}
	...
	public org.eclipse.crossmeter.repository.model.Person getCreator() {
		if (creator == null && dbObject.containsField("creator")) {
			creator = (org.eclipse.crossmeter.repository.model.Person) PongoFactory.getInstance().createPongo((DBObject) dbObject.get("creator"));
		}
		return creator;
	}
	
	public Request setCreator(org.eclipse.crossmeter.repository.model.Person creator) {
