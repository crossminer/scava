...
public class BugTS extends Tracker {
	...
	protected org.eclipse.crossmeter.repository.model.Person assignee = null;
	protected org.eclipse.crossmeter.repository.model.Person submitted = null;
	...
	public BugTS() { 
		...
		LOCATION.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
		STATUS.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
		DESCRIPTION.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
		PRIORITY.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
		RESOLUTIONSTATUS.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
		BUGVISIBILITY.setOwningType("org.eclipse.crossmeter.repository.model.sourceforge.BugTS");
	}
	...
	public org.eclipse.crossmeter.repository.model.Person getAssignee() {
		if (assignee == null && dbObject.containsField("assignee")) {
			assignee = (org.eclipse.crossmeter.repository.model.Person) PongoFactory.getInstance().createPongo((DBObject) dbObject.get("assignee"));
		}
		return assignee;
	}
	
	public BugTS setAssignee(org.eclipse.crossmeter.repository.model.Person assignee) {
	...
	public org.eclipse.crossmeter.repository.model.Person getSubmitted() {
		if (submitted == null && dbObject.containsField("submitted")) {
			submitted = (org.eclipse.crossmeter.repository.model.Person) PongoFactory.getInstance().createPongo((DBObject) dbObject.get("submitted"));
		}
		return submitted;
	}
	
	public BugTS setSubmitted(org.eclipse.crossmeter.repository.model.Person submitted) {
