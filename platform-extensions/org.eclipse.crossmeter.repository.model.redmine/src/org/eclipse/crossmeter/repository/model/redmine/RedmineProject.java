...
public class RedmineProject extends org.eclipse.crossmeter.repository.model.Project {
	...
	public RedmineProject() { 
		...
		super.setSuperTypes("org.eclipse.crossmeter.repository.model.redmine.Project");
		IDENTIFIER.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		DESCRIPTION.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		CREATED_ON.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		UPDATED_ON.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		USERNAME.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		PASSWORD.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		TOKEN.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
		BASEREPO.setOwningType("org.eclipse.crossmeter.repository.model.redmine.RedmineProject");
	}
