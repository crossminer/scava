...
public class RascalManager {
	...
	public static final String MODULE = "org::eclipse::crossmeter::metricprovider::Manager";
	...
	private Evaluator createEvaluator() {
		...
		ModuleEnvironment moduleRoot = new ModuleEnvironment("******crossmeter******", heap);
	...
	public synchronized List<IMetricProvider> getMetricProviders() {
		...
		IExtensionPoint extensionPoint = Platform.getExtensionRegistry().getExtensionPoint("crossmeter.rascal.extractor");
		...
		extensionPoint = Platform.getExtensionRegistry().getExtensionPoint("crossmeter.rascal.metricprovider");
