...
import static org.eclipse.crossmeter.metricprovider.rascal.PongoToRascal.makeMap;
import static org.eclipse.crossmeter.metricprovider.rascal.PongoToRascal.makeProjectLoc;
import static org.eclipse.crossmeter.metricprovider.rascal.RascalToPongo.toPongo;
...
import org.eclipse.crossmeter.metricprovider.rascal.trans.model.MeasurementCollection;
...
import org.eclipse.crossmeter.platform.vcs.workingcopy.manager.Churn;
import org.eclipse.crossmeter.platform.vcs.workingcopy.manager.WorkingCopyCheckoutException;
import org.eclipse.crossmeter.platform.vcs.workingcopy.manager.WorkingCopyFactory;
import org.eclipse.crossmeter.platform.vcs.workingcopy.manager.WorkingCopyManagerUnavailable;
...
public class RascalMetricProvider implements ITransientMetricProvider<RascalMetrics> {
	...
	// Removes org.eclipse.crossmeter.metricprovider. qualifier from an id to accomodate mongo db collection name limit of 120 bytes. 
	private String trimIdForMongo(String fullId) {
		return fullId.replace("org.eclipse.crossmeter.metricprovider.", "");
	}
