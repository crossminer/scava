...
public class Article implements Threadable, Comparable<Article>{
...
//    @Override
    ...
    public int compareTo(Article compareArticle) {
    	...
    	long compareQuantity = ((Article) compareArticle).getArticleNumber(); 
    	
    	//ascending order
    	return (int) (articleNumber - compareQuantity);
