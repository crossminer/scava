...
public class ArticleData extends Pongo {
	...
	public ArticleData() { 
		...
		URL.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		ARTICLENUMBER.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		ARTICLEID.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		DATE.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		FROM.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		SUBJECT.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		REFERENCES.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
		BODY.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.ArticleData");
	}
