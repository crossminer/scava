...
public class NewsgroupData extends Pongo {
	...
	public NewsgroupData() { 
		super();
		NAME.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		URL.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		AUTHENTICATIONREQUIRED.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		USERNAME.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		PASSWORD.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		PORT.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		INTERVAL.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		LASTARTICLECHECKED.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
		FIRSTARTICLE.setOwningType("org.eclipse.crossmeter.platform.communicationchannel.nntp.local.model.NewsgroupData");
	}
