 ...
 ******************************************************************************/
package org.eclipse.crossmeter.repository.model.cc.zendesk;
...
public class Zendesk extends org.eclipse.crossmeter.repository.model.CommunicationChannel {
	
	
	
	public Zendesk() { 
		super();
		super.setSuperTypes("org.eclipse.crossmeter.repository.model.cc.zendesk.CommunicationChannel");
		AUTHENTICATIONREQUIRED.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		USERNAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		PASSWORD.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		PORT.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		DESCRIPTION.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		NAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		INTERVAL.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		LASTARTICLECHECKED.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
		NEWSGROUPNAME.setOwningType("org.eclipse.crossmeter.repository.model.cc.zendesk.Zendesk");
	}
