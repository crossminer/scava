...
public class MyUsernamePasswordAuthProvider
	...
	public static class MySignup extends MyLogin {
		...
		public String validate() {
			if (password == null || !password.equals(repeatPassword)) {
				return Messages
						.get("ossmeter.password.signup.error.passwords_not_same");
			}
			return null;
		}
	}
	...
	protected String getVerifyEmailMailingSubject(
		...
		return Messages.get("ossmeter.password.verify_signup.subject");
	}
	...
	protected String onLoginUserNotFound(final Context context) {
		context.flash()
				.put(controllers.Application.FLASH_ERROR_KEY,
						Messages.get("ossmeter.password.login.unknown_user_or_pw"));
	...
	protected String getPasswordResetMailingSubject(final User user,
			final Context ctx) {
		return Messages.get("ossmeter.password.reset_email.subject");
	}
	...
	protected String getVerifyEmailMailingSubjectAfterSignup(final User user,
			final Context ctx) {
		return Messages.get("ossmeter.password.verify_email.subject");
	}
