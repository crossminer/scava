...
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME,
	...
	property = "_type")
@JsonSubTypes({
	@Type(value = ProgrammingLanguage.class, name="org.eclipse.crossmeter.repository.model.sourceforge.ProgrammingLanguage"), })
@JsonIgnoreProperties(ignoreUnknown = true)
public class ProgrammingLanguage extends NamedElement {
