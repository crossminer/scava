package org.eclipse.scava.repository.model.metrics;
...
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME,
	...
	property = "_type")
@JsonSubTypes({
	@Type(value = MetricVisualisation.class, name="org.eclipse.scava.repository.model.metrics.MetricVisualisation"), })
