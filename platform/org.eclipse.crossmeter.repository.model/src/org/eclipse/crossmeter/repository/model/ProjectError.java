...
public class ProjectError extends Pongo {
	...
	public ProjectError() { 
		super();
		DATE.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		DATEFORERROR.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		PROJECTID.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		PROJECTNAME.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		WORKERIDENTIFIER.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		CLAZZ.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
		STACKTRACE.setOwningType("org.eclipse.crossmeter.repository.model.ProjectError");
	}
