...
public class MetricAnalysis extends Pongo {
	...
	public MetricAnalysis() { 
		super();
		METRICID.setOwningType("org.eclipse.crossmeter.repository.model.MetricAnalysis");
		PROJECTID.setOwningType("org.eclipse.crossmeter.repository.model.MetricAnalysis");
		ANALYSISDATE.setOwningType("org.eclipse.crossmeter.repository.model.MetricAnalysis");
		EXECUTIONDATE.setOwningType("org.eclipse.crossmeter.repository.model.MetricAnalysis");
		MILLISTAKEN.setOwningType("org.eclipse.crossmeter.repository.model.MetricAnalysis");
	}
